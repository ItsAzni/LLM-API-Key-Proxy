...
from .providers.github_copilot_auth_base import GitHubCopilotAuthBase
from .providers.gitlab_duo_auth_base import GitLabDuoAuthBase
...
PROVIDER_MAP = {
    ...
    "github_copilot": GitHubCopilotAuthBase,
    "gitlab_duo": GitLabDuoAuthBase,
}
