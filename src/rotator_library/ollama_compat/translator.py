...
def ollama_to_openai_request(
    ...
    # Enable high reasoning for all models via Ollama
    # Ollama clients (like Raycast) can't control reasoning parameters,
    # so we always request high reasoning effort for the best experience.
    # Models that don't support reasoning will simply ignore this parameter.
